                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 text-center font-bold text-2xl">
                    ...
                    <div class="grid grid-cols-3 gap-6 p-6 text-center text-2xl font-bold">
                        ...
                        <a
                            ...
                            style="background-image: url('{{ asset('budget.jpeg') }}'); background-size: cover; background-position: center;"
                        >
                        ...
                        <a
                            ...
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('expense.png') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
                        ...
                        <a
                            ...
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('income.jpg') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
                        ...
                        <a
                            href="{{ route('report') }}"
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('report.jpeg') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
                        ...
                        <a
                            href="{{ route('invoice') }}"
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('invoice.png') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
                        ...
                        <a
                            href="{{ route('staff') }}"
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('staff.jpg') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
                        ...
                        <a
                            ...
                            class="group relative flex flex-col items-center justify-center h-40 text-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 transform hover:scale-105"
                            style="background-image: url('{{ asset('attendance.jpeg') }}'); background-size: cover; background-position: center;"
                        >
                            <!-- Overlay for dim effect -->
                            <div class="absolute inset-0 bg-black opacity-50 group-hover:opacity-30 transition duration-300"></div>
